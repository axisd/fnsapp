...
ModelReceiptItem::ModelReceiptItem() : SaxSerializerBase("ReceiptItem")
{

}

ModelReceiptItem::ModelReceiptItem(unsigned int __receipt) : SaxSerializerBase("ReceiptItem"),
	m_receipt(__receipt)
{

}

SSCO::ModelReceiptItem::ModelReceiptItem( const unsigned int __id, 
...
void ModelReceiptItem::serialize(QXmlStreamWriter& __writer)
{
...
void ModelReceiptItem::deserialize (QXmlStreamReader& __reader)
{
...
currency ModelReceiptItem::totalWithDisc()
{
	currency total(0);
